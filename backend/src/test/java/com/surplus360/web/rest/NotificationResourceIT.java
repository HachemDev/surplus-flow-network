...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_TYPE = NotificationType.SURPLUS_MATCH;
    private static final NotificationType UPDATED_TYPE = NotificationType.TRANSACTION_UPDATE;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.read(UPDATED_READ).priority(UPDATED_PRIORITY).createdAt(UPDATED_CREATED_AT);
